 ...
 * @method $this clearable(bool $bool) 是否支持清空选项
 * @method $this showAllLevels(bool $bool) 输入框中是否显示选中值的完整路径
 * @method $this collapseTags(bool $bool) 多选模式下是否折叠Tag
 * @method $this separator(string $symbol) 选项分隔符
 * @method $this filterable(bool $bool) 是否可搜索选项
