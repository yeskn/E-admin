...
class Plug extends BaseAdmin
{
    ...
    public function index()
    {
        ...
        $body = Component::fetch(__DIR__.'/../view/plug.vue');
        $view = $content->title('插件管理 | &nbsp;' . $button)->body($body)->view();
